...
export declare class EventTemplatesController implements IConfigurable, IReferenceable, ICommandable, IEventTemplatesController {
    ...
    getTemplateById(correlationId: string, id: string, callback: (err: any, template: EventTemplateV1) => void): void;
    ...
    deleteTemplateById(correlationId: string, id: string, callback: (err: any, template: EventTemplateV1) => void): void;
}
